...
class _ErrorAlertState extends State<ErrorAlert> {
  ...
  Widget build(BuildContext context) {
    ...
    return _buildAlert(
      ...
      _buildGlassyIcon(MIcons.errorAlert),
      widget.message,
    );
  }
...
class _WarningAlertState extends State<WarningAlert> {
  ...
  Widget build(BuildContext context) {
    ...
    return _buildAlert(
      ...
      const Color.fromRGBO(230, 229, 243, 1.0).withOpacity(0.4),
      _buildGlassyIcon(MIcons.warningAlert),
      widget.message,
    );
  }
...
class _SuccessAlertState extends State<SuccessAlert> {
  ...
  Widget build(BuildContext context) {
    ...
    return _buildAlert(
      const Color.fromRGBO(193, 238, 234, 1.0).withOpacity(0.4),
      const Color.fromRGBO(230, 229, 243, 1.0).withOpacity(0.4),
      _buildGlassyIcon(MIcons.successAlert),
      widget.message,
    );
  }
    ...
    return Stack(
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            shape: BoxShape.circle,
            color: const Color.fromRGBO(193, 238, 232, 1.0).withOpacity(0.4),
            border: Border.all(
              color: const Color.fromRGBO(230, 229, 243, 1.0).withOpacity(0.4),
              width: 1.5,
            ),
...
class _InformativeAlertState extends State<InformativeAlert> {
  ...
  Widget build(BuildContext context) {
    ...
    return _buildAlert(
      const Color.fromRGBO(205, 229, 241, 1.0).withOpacity(0.4),
      const Color.fromRGBO(230, 229, 243, 1.0).withOpacity(0.4),
      _buildGlassyIcon(MIcons.InformativeAlert),
      widget.message,
    );
  }
    ...
    return Stack(
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            shape: BoxShape.circle,
            color: const Color.fromRGBO(205, 229, 241, 1.0).withOpacity(0.4),
            border: Border.all(
              color: const Color.fromRGBO(230, 229, 243, 1.0).withOpacity(0.4),
              width: 1.5,
            ),
