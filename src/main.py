...
#     append it to the dataset in the predicted class folder, and retrain the model.
#     """
...
async def log_requests(request: Request, call_next):
    """
    Middleware to monitor requests for performance metrics.
    Logs latency, path, method, and response status dynamically.
    """
